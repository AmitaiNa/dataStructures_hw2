...
public:
    ...
    */
    ...
    /**
		Inorder traverse inserting all entities to the given array.
        @param array The array to put all the entities. MUST be in the sufficient size.
    */
    void get_all_entities(T* array); 
...
template <class T, class Compare>
void AVL_Tree<T, Compare>::get_all_entities(T* array)
{
    if (__root == nullptr)
    {
        return;
