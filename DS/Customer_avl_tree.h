...
class Customer_AVL_Tree : public AVL_Tree<Customer*>
{
    ...
    class path_discount_Output
    {
        ...
        public:
            path_discount_Output(Linked_List<Customer_AVL_Tree::Tree_Node*> path, double cumulative_discount = -1) : __path(path), __cumulative_discount(cumulative_discount)
            {}

            Linked_List<Customer_AVL_Tree::Tree_Node*> get_path() const {return __path;}
    ...
    */
    ...
    /**
        ...
        @param customer_ptr The customer to find.
    ...
    */
    path_discount_Output traverse_by_customer(Customer *customer_ptr) const;
    ...
    */ 
    Customer_AVL_Tree::Tree_Node* find_lowest_common_ancestor(int id1, int id2) const;
...
public:
    ...
    */
    ...
    /**
        ...
        @param customer_ptr The member to be inserted into the tree.
    ...
    */ 
    Customer** insert(Customer* const &customer_ptr) override;
